...
@Component({
  ...
  styleUrls: ['./town.component.less']
})
export class TownComponent implements OnChanges {
  isSpinning = false;
  dataTable: any;  
  data: any;  
  map = Town;
  ...
  constructor(private message: NzMessageService, private request: RequestHandlerService) { 
    this.actions = ActionProvider.pageActions(Pages.town)  
    this.isSpinning = true;
    this.preffixUrl = PreffixUrl.Town;
